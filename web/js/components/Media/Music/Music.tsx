...
import { constantQ, firLoader, waveformLoader } from 'js/components/Media/Music/VisualizationUtils';

import { fetchPlaylistAction } from 'js/components/Media/Music/actions';

import AudioInfo from 'js/components/Media/Music/AudioInfo';
import AudioUI from 'js/components/Media/Music/AudioUI';
import AudioVisualizer from 'js/components/Media/Music/AudioVisualizer';
import MusicPlaylist from 'js/components/Media/Music/MusicPlaylist';
...
interface MusicDispatchToProps {
    fetchPlaylistAction: (track: string) => any;
    // fetchPlaylistAction: (...args: any[]) => any;
}
...
type MusicPropsMerged = MusicProps & MusicDispatchToProps;

class Music extends React.Component<MusicPropsMerged, MusicState> {
    autoPlay = false;
    wasPlaying = false;
    loaded = false;
    ...
    waitForPlaylist = async () => {
        try {
            const firstTrack: MusicItem = await this.props.fetchPlaylistAction(this.props.match.params.track);
