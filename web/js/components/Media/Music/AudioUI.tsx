...
import { setHoverPlaypause, setHoverSeekring, setMouseMove } from 'js/components/Media/Music/actions';
import { PauseButton, PauseIcon, PlayButton, PlayIcon } from 'js/components/Media/Music/Buttons';
import { cartesianToPolar, formatTime } from 'js/components/Media/Music/VisualizationUtils';
...
interface AudioUIDispatchToProps {
    setHoverSeekring: (isHoverSeekring: boolean, angle: number) => void;
    setHoverPlaypause: (isHoverPlaypause: boolean) => void;
    setMouseMove: (isMouseMove: boolean) => void;
}
...
interface AudioUIProps {
    ...
    onStartDrag: (percent: number) => void;
    pause: () => void;
    play: () => void;
    seekAudio: (percent: number) => void;
}

type AudioUIMergedProps = AudioUIProps & AudioUIStateToProps & AudioUIDispatchToProps;
...
class AudioUI extends React.Component<AudioUIMergedProps, {}> {
