...
import { storeRadii } from 'js/components/Media/Music/actions';
import { constantQ, drawCircleMask, firLoader, polarToCartesian, waveformLoader } from 'js/components/Media/Music/VisualizationUtils';
...
interface AudioVisualizerDispatchToProps {
    storeRadii: (innerRadius: number, outerRadius: number) => void;
}
...
type AudioVisualizerPropsMerged = AudioVisualizerStateToProps & AudioVisualizerDispatchToProps & AudioVisualizerProps;

class AudioVisualizer extends React.Component<AudioVisualizerPropsMerged, {}> {
