...
export const LoadingSVG: React.SFC<{}> = () => (
    <svg style={{ display: 'none' }}>
        <symbol id="loading-template">
...
export const LoadingInstance: React.SFC<React.SVGAttributes<{}>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
        ...
        <use xlinkHref="#loading-template" />
    </svg>
);
