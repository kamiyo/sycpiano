...
const SycStore = () => register('store', import(/* webpackChunkName: 'sycStore' */ 'src/components/Shop'));
                                        ...
                                        <FadingContainer>
                                            <Switch location={this.props.location}>
                                                ...
                                                <Route
                                                    path="/store"
                                                    exact={true}
                                                    render={(childProps) => <AsyncComponent<ShopProps> moduleProvider={SycStore} {...childProps} isMobile={matches} />}
                                                />
                                                <Route
                                                    path="/"
                                                    exact={true}
